...
class Program
{
    ...
    static void MostrarReportes(ExamenDbContext db)
    {
        while (true)
        {
            Console.Clear();
    ...
    static void AgregarPregunta(ExamenDbContext db)
    {
        Console.Clear();
    ...
    static void FiltrarResultadosPorAlumno(ExamenDbContext db) {
    ...
    static void InformeEstadisticoPorPregunta(ExamenDbContext db) {
        Console.Clear();
