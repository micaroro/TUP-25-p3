...
class Program
{
    static void Main()
    {
        ...
        var cJuan = new Cliente("Juan Gomez");
        cJuan.Agregar(new CuentaOro("00777", 10000));
        cJuan.Agregar(new CuentaPlata("10456", 22000));

        var cMarta = new Cliente("Marta Diaz");
        cMarta.Agregar(new CuentaOro("67543", 18000));

        var cAgustin = new Cliente("Agustin Gonzalez");
        cAgustin.Agregar(new CuentaPlata("10443", 43000));
        cAgustin.Agregar(new CuentaPlata("10333", 50000));

        var cEnrique = new Cliente("Enrique Sanchez");
        cEnrique.Agregar(new CuentaBronce("10805", 75000));
        cEnrique.Agregar(new CuentaPlata("12305", 10000));

        var cLaura = new Cliente("Laura Lopez");
        cLaura.Agregar(new CuentaOro("13406", 10000));

        var cGiuliana = new Cliente("Giuliana Sosa");
        ...
        nac.Registrar(new Deposito(cJuan.Cuentas[0], 100));
        nac.Registrar(new Retiro(cJuan.Cuentas[1], 200));
        nac.Registrar(new Transferencia(cJuan.Cuentas[0], cJuan.Cuentas[1], 300));
        nac.Registrar(new Transferencia(cAgustin.Cuentas[0], cAgustin.Cuentas[1], 500));
        nac.Registrar(new Pago(cJuan.Cuentas[1], 400));
        ...
        mac.Registrar(new Transferencia(cEnrique.Cuentas[0], cJuan.Cuentas[1], 300));
