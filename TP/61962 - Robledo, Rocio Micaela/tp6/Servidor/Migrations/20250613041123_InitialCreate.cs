    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Galaxy A32", "https://via.placeholder.com/200", "Celular Samsung", 150000m, 10 },
                    { 2, "Core i5, 8GB RAM", "https://via.placeholder.com/200", "Notebook Lenovo", 350000m, 5 },
                    { 3, "Bluetooth", "https://via.placeholder.com/200", "Auriculares JBL", 25000m, 15 }
                });
