...
class PreguntaExamen
{
    ...
    public virtual List<RespuestaAlumno> Respuestas { get; set; } = new();
}
...
class RespuestaAlumno
{
    ...
    public int PreguntaExamenId { get; set; }
    public virtual PreguntaExamen Pregunta { get; set; }

    public int ExamenRealizadoId { get; set; }
    public virtual ExamenRealizado Examen { get; set; }

    public bool EsCorrecta { get; set; }
}

class ExamenContexto : DbContext
{
    public DbSet<PreguntaExamen> Preguntas { get; set; }
    public DbSet<ExamenRealizado> Examenes { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<RespuestaAlumno>()
            ...
            .HasForeignKey(r => r.PreguntaExamenId);

        modelBuilder.Entity<RespuestaAlumno>()
            .HasOne(r => r.Examen)
            .WithMany(e => e.Respuestas)
            .HasForeignKey(r => r.ExamenRealizadoId);
    }
}
...
class Program
{
    ...
    {
        using (var db = new ExamenContexto())
        {
    ...
    static void TomarExamen()
    {
        ...
        foreach (var p in preguntas)
        {
            ...
            respuestas.Add(new RespuestaAlumno
            {
                PreguntaExamenId = p.PreguntaExamenId,
        ...
        var resultado = new ExamenRealizado
        {
            NombreAlumno = nombre,
        ...
        db.Examenes.Add(resultado);
        db.SaveChanges();

        foreach (var r in respuestas)
        {
            r.ExamenRealizadoId = resultado.ExamenRealizadoId;
        }
